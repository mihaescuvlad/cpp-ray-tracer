...
// configuration step. It creates a namespace called `cpp_ray_tracer`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_ray_tracer::cmake::project_name, cpp_ray_tracer::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_ray_tracer::cmake::project_version);
      return EXIT_SUCCESS;
    }
